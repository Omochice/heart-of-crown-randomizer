...
- [x] 3.1 shuffle関数の基本テスト作成（エッジケースとバリデーション）
  - 空配列のシャッフルテスト（空配列を返す）
...
- [x] 3.5 (P) shuffle関数のプロパティベーステスト作成
...
- [x] 6.8 select関数のリファクタリングとドキュメント
...
- [x] 7.1 (P) select関数のプロパティベーステスト作成
