...
export const commons = [
  ...
  },
  {
    ...
    effect: dedent`
      次の効果の中から1つを選んで得る。
      1コイン支払う。
      そうした場合、手札から「農村」を1枚追放する。
      その後、「都市」を1枚マーケットから手札に加える。
      1コイン支払う。
      そうした場合、手札から「都市」を1枚追放する。
      その後、「大都市」を1枚マーケットから手札に加える。
    `,
    edition: 0,
  },
  {
  ...
  },
  {
    ...
    link: 2,
    effect: dedent`
      あなたの山札の一番上から2枚のカードを見る。
      その中から、好きな枚数のカードを捨て、残りを好きな順番で山札の一番上に戻す。
      その後、カードを1枚引く。
    `,
    edition: 0,
  },
  {
    ...
    link: 0,
    effect: dedent`
      このターン中に、初めて「魔法の護符」をプレイしている場合、次の効果の中から1つを選んで得る。
      あなたの〔捨て札か手札〕にある《災い》カードを1枚追放する。
      あなたの捨て札にある《行動・継承権》カードを1枚手札に加える。
    `,
    edition: 0,
  },
  {
  ...
  },
  {
    ...
    effect: dedent`
      カードを1枚引く。
      〔手札を5枚以上持つ全ての対戦相手〕は、各自の手札から〔コストが5以上のカード〕を1枚捨てる。
    ...
    cards: [
      {
        ...
        effect: dedent`
          （このカードは「お付きの侍女」である。
          「お付きの侍女」同士はマーケットでスタックし、スタックしたカードの中から選んで購入・獲得出来る。
          ）このカードを購入したとき、あなたの直轄地があるなら、このカードをセットしてもよい。
          このカードを直轄地にセットした時、次の効果を得る。
          〔全ての対戦相手〕は、「呪い」をマーケットから1枚取り各自の山札の一番上に公開して置く。
        `,
      },
      {
        name: "お付きの侍女 プティー",
      ...
      },
      {
        ...
        effect: dedent`
          ...
          「お付きの侍女」同士はマーケットでスタックし、スタックしたカードの中から選んで購入・獲得出来る。
          ）このカードを購入したとき、あなたの直轄地があるなら、このカードをセットしてもよい。
          このカードを直轄地にセットした時、あなたは「コインカウンター」を1個得る。
        `,
      },
      {
        name: "お付きの侍女 リリー",
        ...
        effect: dedent`
          ...
          「お付きの侍女」同士はマーケットでスタックし、スタックしたカードの中から選んで購入・獲得出来る。
          ）このカードを購入したとき、あなたの直轄地があるなら、このカードをセットしてもよい。
          （このカードが直轄地にセットされている時）3コイン支払う：あなたの直轄地にあるプリンセスカードの上に「+1継承権カウンター」を1個置く。
  ...
  },
  {
    ...
    link: 0,
    effect: dedent`
      〔手札を5枚以上持つ全ての対戦相手〕は、各自の手札から《領地》カードを1枚捨てる。
      手札に《領地》カードが無い場合は、手札を公開する。
    `,
    edition: 0,
  },
  {
  ...
  },
  {
    ...
    link: 0,
    effect: dedent`
      1コイン支払うか、手札から《行動・継承権》カードを1枚選んで追放する。
      そうした場合、次の効果の中から1つを選んで得る。
  ...
  },
  {
    ...
    effect: dedent`
      手札から《災い》以外のカードを1枚追放する。
      そうした場合、〔追放したカードのコスト+2以下のコストを持つカード〕をマーケットから1枚獲得する。
    `,
    edition: 0,
  },
  {
    ...
    effect: dedent`
      カードを1枚引く。
      〔手札を5枚以上持つ全ての対戦相手〕は、各自の手札から《行動・継承権》カードを1枚捨てる。
      手札に《行動・継承権》カードがない場合、手札を公開する。
